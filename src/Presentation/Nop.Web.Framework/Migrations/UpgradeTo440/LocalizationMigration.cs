    ...
    public class LocalizationMigration : MigrationBase
    {
        ...
        public override void Up()
        {
            ...
            localizationService.AddLocaleResourceAsync(new Dictionary<string, string>
            {
                ...
                ["Admin.ConfigurationSteps.EmailAccountList.EmailAccounts1.Text"] = "You can see all the existing email accounts on this page. The only one email account is created automatically during the installation process. You can also create a general contact email, a sales representative email, a customer support email and more to contact to your customers.",
                ["Admin.ConfigurationSteps.EmailAccountList.EmailAccounts2.Title"] = "Email accounts",
                ["Admin.ConfigurationSteps.EmailAccountList.EmailAccounts2.Text"] = "Then, these email accounts will be used to send order notications, registration emails and newsletter to your customers. But you can use the only one email account for all these purposes.",
